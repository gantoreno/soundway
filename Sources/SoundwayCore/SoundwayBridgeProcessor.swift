...
internal final class SoundwayBridgeProcessor {
    ...
    init(settings: Settings) {
        ...
        self.bridgeChannelCount = max(1, max(Int(settings.inputChannelCount), Int(settings.outputChannelCount)))
    ...
    func renderOutput(frameCount: Int) -> SoundwayAudioBlock {
        ...
        var output = SoundwayAudioBlock.silence(channelCount: outputChannelCount, frameCount: frameCount)
